...
namespace QuanLyPhongMay_newvers.Class
{
    class Functions
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = @"Data Source=DESKTOP-MFK3I4Q\SQLEXPRESS;Initial Catalog=QuanLyPhongMay;Integrated Security=True";
            Con.Open();
